          ...
          <van-cell title="深色模式" is-link>
            <template #icon>
              <svg t="1667459424354" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="4350" width="16" height="16" style="margin-right:8px;">
                <path
                  ...
                  p-id="4351" fill="var(--van-nav-bar-icon-color)"></path>
              </svg>
            </template>
          </van-cell>
          <van-cell title="定时关闭" is-link>
            <template #icon>
              <svg t="1667459003659" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="8685" width="16" height="16" style="margin-right:8px;">
                <path
                  ...
                  fill="var(--van-nav-bar-icon-color)" p-id="8686"></path>
                <path
                  ...
                  fill="var(--van-nav-bar-icon-color)" p-id="8687"></path>
                <path
                  ...
                  fill="var(--van-nav-bar-icon-color)" p-id="8688"></path>
              </svg>
            </template>
          </van-cell>
          <van-cell title="个性装扮" is-link>
            <template #icon>
              <svg t="1667459597689" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="6429" width="16" height="16" style="margin-right:8px;">
                <path
                  ...
                  fill="var(--van-nav-bar-icon-color)" p-id="6430"></path>
              </svg>
            </template>
          </van-cell>
          ...
          <van-cell title="音乐黑名单" is-link>
            <template #icon>
              <svg t="1667459899723" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="16136" width="16" height="16" style="margin-right:8px;">
                <path
                  ...
                  p-id="16137" fill="var(--van-nav-bar-icon-color)"></path>
              </svg>
            </template>
          </van-cell>
